package br.com.marketimobi.api.exception.handler;
...
@ControllerAdvice
public class MarketimobiExceptionHandler extends ResponseEntityExceptionHandler {
	
	private static final Logger logger = LoggerFactory.getLogger(MarketimobiExceptionHandler.class);
	...
	public ResponseEntity<Object> handleDataIntegrityViolationException(DataIntegrityViolationException ex, WebRequest request) {
		...
		if(err instanceof ConstraintViolationException) {
			mensagemUsuario = "Registro já existente.";
		}
